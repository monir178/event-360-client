...
const GallerySection = () => {
  return (
    <Container className="relative mt-24 grid grid-cols-1 lg:grid-cols-2 place-content-center items-center">
      <div>
        ...
        <p className="text-textcolor mb-6 max-w-[50ch]">
          ...
          gallery. From intimate gatherings to grand celebrations, our carefully
          curated collection of photos brings each event to life. Explore the
          essence of our occasions and find inspiration for your next
          unforgettable event.
        </p>
